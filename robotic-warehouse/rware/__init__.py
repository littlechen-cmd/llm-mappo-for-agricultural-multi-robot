...
from rware.heterogeneous import WAREHOUSE_SIZES


register(
    id="rware-heterogeneous-v0",
    entry_point="rware.heterogeneous:HeterogeneousWarehouse",
    disable_env_checker=True,
)


for _heterogeneous_size in WAREHOUSE_SIZES:
    for _heterogeneous_agents in range(1, 7):
        _heterogeneous_kwargs = {
            "size": _heterogeneous_size,
            "n_agvs": _heterogeneous_agents,
        }
        for _heterogeneous_id in (
            f"rware-heterogeneous-{_heterogeneous_size}-{_heterogeneous_agents}ag-v0",
            f"rware-{_heterogeneous_size}-{_heterogeneous_agents}ag-heterogeneous-v0",
        ):
            register(
                id=_heterogeneous_id,
                entry_point="rware.heterogeneous:HeterogeneousWarehouse",
                kwargs=_heterogeneous_kwargs,
                disable_env_checker=True,
            )
